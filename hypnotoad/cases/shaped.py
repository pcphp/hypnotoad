...
class ShapedEquilibrium(Equilibrium):
    """
    Magnetic configuration with shaped tokamak, can be either SOL-only with a limiter at the inboard midplane or core-only.
    """
